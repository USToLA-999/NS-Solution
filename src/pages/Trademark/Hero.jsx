                ...
                <div className="mx-auto md:mx-auto  lg:mt-10 sm:mt-10">
                    <div className="headerlines pt-5 pb-2 mx-auto lg::mx-auto text-wrap  justify-center items-center ">
                        ...
                        <div className="paralines mt-3 md:mt-5 sm:mt-5 ">
                            <p className="text-xl ">Trademark Registration just <b> Rs: 6499/- with UD49m Rs: 7499/- </b></p>
                            <p className="text-xl ">Digital signature for <b> individual</b> <b> just Rs: 1499/- </b> </p>
                            <p className="text-xl ">Digital signature for <b> Business</b> just <b> Rs: 2499/-  </b></p>
                        </div>
