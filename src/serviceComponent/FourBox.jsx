                    ...
                    <div className="grid lg:grid-cols-2 mx-auto justify-center items-center md:grid-cols-1  gap-10 sm:grid-cols-1    ">
                        ...
                        <div className="relative flex text-xl  pt-4 pb-4 px-4  w-full   flex-col  justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
                                <div className="headercontent mt-4">
                                    <h1 className="text-2xl lg:text-2xl">File Income Tax Return  with Online Texas</h1>
                                </div>
                                <div className="paralines mt-3 mb-3">
                                    <ul className="lists mx-5 text-start text-xl">
                                        <li className="mt-2">Largest Tax Filing Portal in India</li>
                                        <li className="mt-2">E-File Directly to the Income Tax Department</li>
                                        <li className="mt-2">E-File for Free</li>
                                        <li className="mt-2">E-File Safely</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="relative flex text-xl  pt-4 pb-4 px-4  w-full   flex-col  justify-center overflow-hidden rounded-lg border bg-background md:shadow-xl">
                            <div className="headercontent mt-4">
                                    <h1 className="text-2xl lg:text-2xl">Completely Hassle-Free</h1>
                                </div>
                                <div className="paralines mt-3 mb-3">
                                    <ul className="lists mx-5 text-start text-xl">
                                        <li className="mt-2">Effortless Way to Be Compliant</li>
                                        <li className="mt-2">Pay Minimum Possible Taxes</li>
                                        <li className="mt-2">Get Maximum Refunds</li>
                                        <li className="mt-2">Error-Free Income Tax Returns = Trouble-Free Income Tax Refunds</li>
                                    </ul>
                                </div>
                            </div>
                        </div>
